...
func TestOffsetCoordinationServerSession(t *testing.T) {
	...
	serverSession := NewServerSession("test-server-session", pathManager, nil, &DefaultSessionLogger{})
...
func TestDataAggregatorOffsetCoordination(t *testing.T) {
	...
	aggregator := data.NewDataAggregator(&TestLogger{})
...
// TestLogger implements DataLogger for testing
...
func (l *TestLogger) Critical(msg string, keysAndValues ...interface{}) {}
