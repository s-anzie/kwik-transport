...
func TestStartTransferResumeExisting(t *testing.T) {
	...
	chunk1 := types.NewFileChunk(1, 0, []byte("test data 1"), "test.txt", 0, 4, false)
...
func TestRecordChunkReceived(t *testing.T) {
	...
	chunk := types.NewFileChunk(1, 0, []byte("test data"), "test.txt", 0, 4, false)
...
func TestGetTransferProgress(t *testing.T) {
	...
	// Record some chunks
	chunk1 := types.NewFileChunk(1, 0, []byte("data1"), "test.txt", 0, 4, false)
	chunk2 := types.NewFileChunk(2, 1, []byte("data2"), "test.txt", 256, 4, false)
...
func TestCannotResumeChangedFile(t *testing.T) {
	...
	// Start initial transfer
	metadata1 := types.NewFileMetadata("test.txt", 1024, 256)
	...
	metadata2 := types.NewFileMetadata("test.txt", 2048, 256) // Different size
...
func TestListResumableTransfers(t *testing.T) {
	...
	metadata1 := types.NewFileMetadata("file1.txt", 1024, 256)
	metadata2 := types.NewFileMetadata("file2.txt", 2048, 512)
...
func TestValidateResumedChunks(t *testing.T) {
	...
	// Record some chunks
	chunk1 := types.NewFileChunk(1, 0, []byte("valid"), "test.txt", 0, 4, false)
	chunk2 := types.NewFileChunk(2, 1, []byte("invalid"), "test.txt", 256, 4, false)
